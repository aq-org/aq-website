...
```C
int AqvmMemoryRegister_SetType(struct AqvmMemoryRegister_Register* _register,
                               size_t index, uint8_t type);

uint8_t AqvmMemoryRegister_GetType(
    struct AqvmMemoryRegister_Register* _register, size_t index);
```
